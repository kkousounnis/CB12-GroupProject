...
CREATE TABLE `contact_numbers` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_contact_numbers_user_id__users_id` (`user_id`),
  CONSTRAINT `fk_contact_numbers_user_id__users_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
