...
--
-- Table structure for table `users_contact_numbers`
--

DROP TABLE IF EXISTS `users_contact_numbers`;
...
CREATE TABLE `users_contact_numbers` (
  ...
  CONSTRAINT `fk_users_contact_numbers_contact_number_id_contact_numbers_id` FOREIGN KEY (`contact_number_id`) REFERENCES `contact_numbers` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- Dump completed on 2021-01-07 10:02:30
